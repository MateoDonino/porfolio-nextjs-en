    ...
    <section className="mt-16">
      ...
      <div className="mt-10 max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
        ...
        <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
          I am currently looking for new job opportunities, my Message box is
          always open. Leave me a message and I will contact you shortly. I am
          also very attentive to myself LinkedIn box.
        </p>
